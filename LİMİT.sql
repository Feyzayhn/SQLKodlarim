...
SELECT * FROM kisiler where id>5 limit 2; --kosul oldugu icin where kullandik
...
select * from kisiler order by maas desc limit 3 offset 3 -- offset 3 ilk 3 den sonrasi limit 3
-- desc tersten siraliyor 
